...
$(BUILD_DIR)/ocpcre.o:   FFLAGS += -fixedform
$(BUILD_DIR)/ocpids.o:   FFLAGS += -fixedform
$(BUILD_DIR)/ocpmix.o:   FFLAGS += -fixedform
$(BUILD_DIR)/swancom1.o: FFLAGS += -fixedform
$(BUILD_DIR)/swancom2.o: FFLAGS += -fixedform
$(BUILD_DIR)/swancom3.o: FFLAGS += -fixedform
$(BUILD_DIR)/swancom4.o: FFLAGS += -fixedform
$(BUILD_DIR)/swancom5.o: FFLAGS += -fixedform
$(BUILD_DIR)/swanmain.o: FFLAGS += -fixedform
$(BUILD_DIR)/swanout1.o: FFLAGS += -fixedform
$(BUILD_DIR)/swanout2.o: FFLAGS += -fixedform
$(BUILD_DIR)/swanparll.o:FFLAGS += -fixedform
$(BUILD_DIR)/swanpre1.o: FFLAGS += -fixedform
$(BUILD_DIR)/swanpre2.o: FFLAGS += -fixedform
$(BUILD_DIR)/swanser.o:  FFLAGS += -fixedform
$(BUILD_DIR)/swmod1.o:   FFLAGS += -fixedform
$(BUILD_DIR)/swmod2.o:       FFLAGS += -fixedform
$(BUILD_DIR)/SwanSpectPart.o:FFLAGS += -fixedform
$(BUILD_DIR)/m_constants.o:  FFLAGS += -freeform
$(BUILD_DIR)/m_fileio.o:     FFLAGS += -freeform
$(BUILD_DIR)/mod_xnl4v5.o:   FFLAGS += -freeform
$(BUILD_DIR)/serv_xnl4v5.o:  FFLAGS += -freeform
$(BUILD_DIR)/nctablemd.o:    FFLAGS += -freeform
$(BUILD_DIR)/agioncmd.o:     FFLAGS += -freeform
$(BUILD_DIR)/swn_outnc.o:    FFLAGS += -freeform
$(BUILD_DIR)/SdsBabanin.o:   FFLAGS += -freeform
$(BUILD_DIR)/SwanBpntlist.o: FFLAGS += -freeform
$(BUILD_DIR)/SwanCheckGrid.o:FFLAGS += -freeform
$(BUILD_DIR)/SwanCompdata.o: FFLAGS += -freeform
$(BUILD_DIR)/SwanCompUnstruc.o:       FFLAGS += -freeform
$(BUILD_DIR)/SwanComputeForce.o:      FFLAGS += -freeform
$(BUILD_DIR)/SwanConvAccur.o:         FFLAGS += -freeform
$(BUILD_DIR)/SwanConvStopc.o:         FFLAGS += -freeform
$(BUILD_DIR)/SwanCreateEdges.o:       FFLAGS += -freeform
$(BUILD_DIR)/SwanCrossObstacle.o:     FFLAGS += -freeform
$(BUILD_DIR)/SwanDiffPar.o:           FFLAGS += -freeform
$(BUILD_DIR)/SwanDispParm.o:          FFLAGS += -freeform
$(BUILD_DIR)/SwanFindObstacles.o:     FFLAGS += -freeform
$(BUILD_DIR)/SwanFindPoint.o:         FFLAGS += -freeform
$(BUILD_DIR)/SwanGridCell.o:          FFLAGS += -freeform
$(BUILD_DIR)/SwanGriddata.o:          FFLAGS += -freeform
$(BUILD_DIR)/SwanGridFace.o:          FFLAGS += -freeform
$(BUILD_DIR)/SwanGridobjects.o:       FFLAGS += -freeform
$(BUILD_DIR)/SwanGridTopology.o:      FFLAGS += -freeform
$(BUILD_DIR)/SwanGridVert.o:          FFLAGS += -freeform
$(BUILD_DIR)/SwanGSECorr.o:           FFLAGS += -freeform
$(BUILD_DIR)/SwanInitCompGrid.o:      FFLAGS += -freeform
$(BUILD_DIR)/SwanInterpolateAc.o:     FFLAGS += -freeform
$(BUILD_DIR)/SwanInterpolateOutput.o: FFLAGS += -freeform
$(BUILD_DIR)/SwanInterpolatePoint.o:  FFLAGS += -freeform
$(BUILD_DIR)/SwanIntgratSpc.o:        FFLAGS += -freeform
$(BUILD_DIR)/SwanPointinMesh.o:       FFLAGS += -freeform
$(BUILD_DIR)/SwanPrepComp.o:          FFLAGS += -freeform
$(BUILD_DIR)/SwanPrintGridInfo.o:     FFLAGS += -freeform
$(BUILD_DIR)/SwanPropvelS.o:          FFLAGS += -freeform
$(BUILD_DIR)/SwanPropvelX.o:          FFLAGS += -freeform
$(BUILD_DIR)/SwanReadADCGrid.o:       FFLAGS += -freeform
$(BUILD_DIR)/SwanReadEasymeshGrid.o:  FFLAGS += -freeform
$(BUILD_DIR)/SwanReadGrid.o:          FFLAGS += -freeform
$(BUILD_DIR)/SwanReadTriangleGrid.o:  FFLAGS += -freeform
$(BUILD_DIR)/SwanSweepSel.o:          FFLAGS += -freeform
$(BUILD_DIR)/SwanThreadBounds.o:      FFLAGS += -freeform
$(BUILD_DIR)/SwanTranspAc.o:          FFLAGS += -freeform
$(BUILD_DIR)/SwanTranspX.o:           FFLAGS += -freeform
