...
!!    wdir=210.0_r8*deg2rad
      ...
      wstart = 2.5_r8*24.0_r8*3600.0_r8
      wdur =18.0_r8*3600.0_r8
      DO j=JstrR,JendR
        DO i=IstrR,IendR
          Hwave(i,j)=0.0_r8
          ...
          Pwave_bot(i,j)=10.0_r8
          ! Lwave(i,j)=20.0_r8
!          if(time(ng).ge.wstart .and. time(ng) .le. wstart+wdur)then
!             Hwave(i,j)=2.0_r8*cos((time(ng)-wstart)*pi/wdur-pi/2.0_r8)
!          endif
        END DO
      END DO
#else
