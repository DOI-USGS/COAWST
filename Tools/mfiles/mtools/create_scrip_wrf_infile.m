function create_scrip_wrf_inifile(wrf_grid_file,mask,out_file)
...
% jcw 31July2014 from scrip_wrf to make this a function.

%load some wrf grid info
lon_rho=ncread(wrf_grid_file,'XLONG');
lat_rho=ncread(wrf_grid_file,'XLAT');
