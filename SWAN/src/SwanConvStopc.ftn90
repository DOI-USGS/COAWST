...
!   41.90,  December 2021: adapted to QCM
!
!   Purpose
!
...
!   Method
!
!   In case of QC modelling, stopping criterion based on absolute and relative changes in wave height only
!   Also note that the curvature criterion is risky because of inherent rapid changes in Hs due to scattering
