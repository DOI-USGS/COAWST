...
#       cmake .. -G "Unix Makefiles" -DUNIX=ON -DMPI=ON -DNETCDF=ON -DCMAKE_VERBOSE_MAKEFILE=ON -DCMAKE_Fortran_COMPILER=mpif90; 
#--------------------------------------------------------------------------
#  Build WW3.
#--------------------------------------------------------------------------
...
ifdef USE_WW3
	...
	mkdir build;                                                                                \
	cd build;                                                                                   \
	cmake .. -DSWITCH=$(COAWST_WW3_DIR)/model/bin/switch_coawst -DCMAKE_VERBOSE_MAKEFILE=ON -DCMAKE_BUILD_TYPE=Release; \
...
tarfile:
		tar --exclude=".svn" --exclude Output* -cvf coawst_v3.9.tar *
