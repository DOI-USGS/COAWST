...
!--------------------------------------------------------------------
! This module is used in MPAS for the MYNN-EDMF scheme and driver. It defines model-specific
! constants/parameters consistently with the host model, derived parameters, model-specific
! tuneable parameters, commonly used non-model-specific constants, and some configuration options.
