...
** git $Id$
********************************************************** Hernan G. Arango ***
** Copyright (c) 2002-2026 The ROMS Group          Alexander F. Shchepetkin  **
...
#if defined DISSIP_BREAK_DIR && \
    (!defined WW3_MODEL && !defined INWAVE_MODEL)
# undef DISSIP_BREAK_DIR
#endif
...
#if defined WDISS_GAMMA || \
    defined WDISS_ROELVINK
# define WDISS_INWAVE
#endif
