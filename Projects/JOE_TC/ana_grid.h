...
!
!! svn $Id: ana_grid.h 38 2007-04-28 01:11:25Z arango $
!!======================================================================
...
!
      ...
      f0=???
      beta=???
#elif defined KEVIN_TC
      Xsize=12000.0_r8*REAL(Lm(ng),r8)
      Esize=12000.0_r8*REAL(Mm(ng),r8)
      depth=150.0_r8
      f0=2.532518E-05_r8
      beta=0.0_r8
#elif defined JOE_TC
...
!
      ...
      DO i=IstrR,IendR
        val1=REAL(i,r8)
        val2=MAX(depth,78.0_r8+165.0_r8*TANH((val1-20.0_r8)/40.0_r8))
        DO j=JstrR,JendR
          h(i,j)=val2
        END DO
      END DO
