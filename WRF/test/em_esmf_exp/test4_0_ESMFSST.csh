...
# @ job_name		= test4_0_ESMFSST.$(jobid)
# @ output		= test4_0_ESMFSST.$(jobid).out
# @ error		= test4_0_ESMFSST.$(jobid).err
...
# on bluesky.  jan00 case modified to read SSTs via ESMF is used.  
# All settings are hard-coded.  
# To use it, type "llsubmit test4_0_ESMFSST.csh" from the 
...
cp -f namelist.input.jan00.ESMFSST namelist.input

# Run WRF
$MPIRUNCOMMAND wrf_SST_ESMF.exe
