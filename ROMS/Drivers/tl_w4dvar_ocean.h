...
!
!svn $Id: tl_w4dvar_ocean.h 429 2009-12-20 17:30:26Z arango $
!=================================================== Andrew M. Moore ===
...
!
        ...
        END DO OUTER_LOOP1
!
!  Set history file ID to closed state since we manipulated its indices
!  with the forward file ID which was closed above.
!
        ncHISid(ng)=-1
!
...
!
! Write out tangent linear model initial conditions and tangent
! linear surface forcing adjutsments for next inner loop into
...
!
          ...
          lstr=LEN_TRIM(TLMbase(ng))
          WRITE (TLMname(ng),10) TLMbase(ng)(1:lstr-3), outer+1
!
...
!  Close tangent linear NetCDF file.
!
          SourceFile='tl_w4dvar.h, ROMS_run'
