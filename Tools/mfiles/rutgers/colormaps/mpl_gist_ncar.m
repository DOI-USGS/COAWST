function cmap = mpl_gist_ncar(varargin)

% MPL_GIST_NCAR: 128 color palette
%
% cmap = mpl_gist_ncar(M)
%
% Gist colormap from NCL NCAR Graphics.
%
...
% Usage:
%
%    colormap(mpl_gist_ncar)
%    colormap(flipud(mpl_gist_ncar))
%
...
cmap = [[0.000000, 0.028620, 0.465106],
