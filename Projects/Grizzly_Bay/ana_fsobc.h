...
!
!! svn $Id: ana_fsobc.h 216 2008-08-08 18:35:19Z arango $
!!======================================================================
...
# elif defined GRIZ_BAY
      ...
      IF (WESTERN_EDGE) THEN
        ramp = TANH((tdays(ng)-dstart)/0.5_r8)
!       cff=-ramp*1.5_r8*sin(2.0_r8*pi*time(ng)/(12.0_r8*3600.0_r8))
        cff=-ramp*3.0_r8*sin(2.0_r8*pi*time(ng)/(12.0_r8*3600.0_r8))
        DO j=JstrR,JendR
