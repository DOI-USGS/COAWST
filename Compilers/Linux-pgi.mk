...
$(BUILD_DIR)/ocpcre.o:   FFLAGS += -Mnofree
$(BUILD_DIR)/ocpids.o:   FFLAGS += -Mnofree
$(BUILD_DIR)/ocpmix.o:   FFLAGS += -Mnofree
$(BUILD_DIR)/swancom1.o: FFLAGS += -Mnofree
$(BUILD_DIR)/swancom2.o: FFLAGS += -Mnofree
$(BUILD_DIR)/swancom3.o: FFLAGS += -Mnofree
$(BUILD_DIR)/swancom4.o: FFLAGS += -Mnofree
$(BUILD_DIR)/swancom5.o: FFLAGS += -Mnofree
$(BUILD_DIR)/swanmain.o: FFLAGS += -Mnofree
$(BUILD_DIR)/swanout1.o: FFLAGS += -Mnofree
$(BUILD_DIR)/swanout2.o: FFLAGS += -Mnofree
$(BUILD_DIR)/swanparll.o:FFLAGS += -Mnofree
$(BUILD_DIR)/swanpre1.o: FFLAGS += -Mnofree
$(BUILD_DIR)/swanpre2.o: FFLAGS += -Mnofree
$(BUILD_DIR)/swanser.o:  FFLAGS += -Mnofree
$(BUILD_DIR)/swmod1.o:   FFLAGS += -Mnofree
$(BUILD_DIR)/swmod2.o:       FFLAGS += -Mnofree
$(BUILD_DIR)/SwanSpectPart.o:FFLAGS += -Mnofree
$(BUILD_DIR)/m_constants.o:  FFLAGS += -Mfree
$(BUILD_DIR)/m_fileio.o:     FFLAGS += -Mfree
$(BUILD_DIR)/mod_xnl4v5.o:   FFLAGS += -Mfree
$(BUILD_DIR)/serv_xnl4v5.o:  FFLAGS += -Mfree
$(BUILD_DIR)/nctablemd.o:    FFLAGS += -Mfree
$(BUILD_DIR)/agioncmd.o:     FFLAGS += -Mfree
$(BUILD_DIR)/swn_outnc.o:    FFLAGS += -Mfree
$(BUILD_DIR)/SdsBabanin.o:   FFLAGS += -Mfree
$(BUILD_DIR)/SwanBpntlist.o: FFLAGS += -Mfree
$(BUILD_DIR)/SwanCheckGrid.o:FFLAGS += -Mfree
$(BUILD_DIR)/SwanCompdata.o: FFLAGS += -Mfree
$(BUILD_DIR)/SwanCompUnstruc.o:       FFLAGS += -Mfree
$(BUILD_DIR)/SwanComputeForce.o:      FFLAGS += -Mfree
$(BUILD_DIR)/SwanConvAccur.o:         FFLAGS += -Mfree
$(BUILD_DIR)/SwanConvStopc.o:         FFLAGS += -Mfree
$(BUILD_DIR)/SwanCreateEdges.o:       FFLAGS += -Mfree
$(BUILD_DIR)/SwanCrossObstacle.o:     FFLAGS += -Mfree
$(BUILD_DIR)/SwanDiffPar.o:           FFLAGS += -Mfree
$(BUILD_DIR)/SwanDispParm.o:          FFLAGS += -Mfree
$(BUILD_DIR)/SwanFindObstacles.o:     FFLAGS += -Mfree
$(BUILD_DIR)/SwanFindPoint.o:         FFLAGS += -Mfree
$(BUILD_DIR)/SwanGridCell.o:          FFLAGS += -Mfree
$(BUILD_DIR)/SwanGriddata.o:          FFLAGS += -Mfree
$(BUILD_DIR)/SwanGridFace.o:          FFLAGS += -Mfree
$(BUILD_DIR)/SwanGridobjects.o:       FFLAGS += -Mfree
$(BUILD_DIR)/SwanGridTopology.o:      FFLAGS += -Mfree
$(BUILD_DIR)/SwanGridVert.o:          FFLAGS += -Mfree
$(BUILD_DIR)/SwanGSECorr.o:           FFLAGS += -Mfree
$(BUILD_DIR)/SwanInitCompGrid.o:      FFLAGS += -Mfree
$(BUILD_DIR)/SwanInterpolateAc.o:     FFLAGS += -Mfree
$(BUILD_DIR)/SwanInterpolateOutput.o: FFLAGS += -Mfree
$(BUILD_DIR)/SwanInterpolatePoint.o:  FFLAGS += -Mfree
$(BUILD_DIR)/SwanIntgratSpc.o:        FFLAGS += -Mfree
$(BUILD_DIR)/SwanPointinMesh.o:       FFLAGS += -Mfree
$(BUILD_DIR)/SwanPrepComp.o:          FFLAGS += -Mfree
$(BUILD_DIR)/SwanPrintGridInfo.o:     FFLAGS += -Mfree
$(BUILD_DIR)/SwanPropvelS.o:          FFLAGS += -Mfree
$(BUILD_DIR)/SwanPropvelX.o:          FFLAGS += -Mfree
$(BUILD_DIR)/SwanReadADCGrid.o:       FFLAGS += -Mfree
$(BUILD_DIR)/SwanReadEasymeshGrid.o:  FFLAGS += -Mfree
$(BUILD_DIR)/SwanReadGrid.o:          FFLAGS += -Mfree
$(BUILD_DIR)/SwanReadTriangleGrid.o:  FFLAGS += -Mfree
$(BUILD_DIR)/SwanSweepSel.o:          FFLAGS += -Mfree
$(BUILD_DIR)/SwanThreadBounds.o:      FFLAGS += -Mfree
$(BUILD_DIR)/SwanTranspAc.o:          FFLAGS += -Mfree
$(BUILD_DIR)/SwanTranspX.o:           FFLAGS += -Mfree
$(BUILD_DIR)/SwanVertlist.o:  FFLAGS += -Mfree
$(BUILD_DIR)/waves_control.o: FFLAGS += -Mfree
$(BUILD_DIR)/waves_coupler.o: FFLAGS += -Mfree
