...
!
!svn $Id: nemuro.h 732 2008-09-07 01:55:51Z jcwarner $
!************************************************** Hernan G. Arango ***
...
!
      ...
      real(r8), dimension(PRIVATE_1D_SCRATCH_ARRAY,N(ng)) :: LightL
      real(r8), dimension(PRIVATE_1D_SCRATCH_ARRAY,N(ng)) :: LightS
