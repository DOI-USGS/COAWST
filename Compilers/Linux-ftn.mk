...
$(BUILD_DIR)/ocpcre.o:   FFLAGS += -fixed-form
$(BUILD_DIR)/ocpids.o:   FFLAGS += -fixed-form
$(BUILD_DIR)/ocpmix.o:   FFLAGS += -fixed-form
$(BUILD_DIR)/swancom1.o: FFLAGS += -fixed-form
$(BUILD_DIR)/swancom2.o: FFLAGS += -fixed-form
$(BUILD_DIR)/swancom3.o: FFLAGS += -fixed-form
$(BUILD_DIR)/swancom4.o: FFLAGS += -fixed-form
$(BUILD_DIR)/swancom5.o: FFLAGS += -fixed-form
$(BUILD_DIR)/swanmain.o: FFLAGS += -fixed-form
$(BUILD_DIR)/swanout1.o: FFLAGS += -fixed-form
$(BUILD_DIR)/swanout2.o: FFLAGS += -fixed-form
$(BUILD_DIR)/swanparll.o:FFLAGS += -fixed-form
$(BUILD_DIR)/swanpre1.o: FFLAGS += -fixed-form
$(BUILD_DIR)/swanpre2.o: FFLAGS += -fixed-form
$(BUILD_DIR)/swanser.o:  FFLAGS += -fixed-form
$(BUILD_DIR)/swmod1.o:   FFLAGS += -fixed-form
$(BUILD_DIR)/swmod2.o:       FFLAGS += -fixed-form
$(BUILD_DIR)/SwanSpectPart.o:FFLAGS += -fixed-form
$(BUILD_DIR)/m_constants.o:  FFLAGS += -free-form
$(BUILD_DIR)/m_fileio.o:     FFLAGS += -free-form
$(BUILD_DIR)/mod_xnl4v5.o:   FFLAGS += -free-form
$(BUILD_DIR)/serv_xnl4v5.o:  FFLAGS += -free-form
$(BUILD_DIR)/nctablemd.o:    FFLAGS += -free-form
$(BUILD_DIR)/agioncmd.o:     FFLAGS += -free-form
$(BUILD_DIR)/swn_outnc.o:    FFLAGS += -free-form
$(BUILD_DIR)/SdsBabanin.o:   FFLAGS += -free-form
$(BUILD_DIR)/SwanBpntlist.o: FFLAGS += -free-form
$(BUILD_DIR)/SwanCheckGrid.o:FFLAGS += -free-form
$(BUILD_DIR)/SwanCompdata.o: FFLAGS += -free-form
$(BUILD_DIR)/SwanCompUnstruc.o:       FFLAGS += -free-form
$(BUILD_DIR)/SwanComputeForce.o:      FFLAGS += -free-form
$(BUILD_DIR)/SwanConvAccur.o:         FFLAGS += -free-form
$(BUILD_DIR)/SwanConvStopc.o:         FFLAGS += -free-form
$(BUILD_DIR)/SwanCreateEdges.o:       FFLAGS += -free-form
$(BUILD_DIR)/SwanCrossObstacle.o:     FFLAGS += -free-form
$(BUILD_DIR)/SwanDiffPar.o:           FFLAGS += -free-form
$(BUILD_DIR)/SwanDispParm.o:          FFLAGS += -free-form
$(BUILD_DIR)/SwanFindObstacles.o:     FFLAGS += -free-form
$(BUILD_DIR)/SwanFindPoint.o:         FFLAGS += -free-form
$(BUILD_DIR)/SwanGridCell.o:          FFLAGS += -free-form
$(BUILD_DIR)/SwanGriddata.o:          FFLAGS += -free-form
$(BUILD_DIR)/SwanGridFace.o:          FFLAGS += -free-form
$(BUILD_DIR)/SwanGridobjects.o:       FFLAGS += -free-form
$(BUILD_DIR)/SwanGridTopology.o:      FFLAGS += -free-form
$(BUILD_DIR)/SwanGridVert.o:          FFLAGS += -free-form
$(BUILD_DIR)/SwanGSECorr.o:           FFLAGS += -free-form
$(BUILD_DIR)/SwanInitCompGrid.o:      FFLAGS += -free-form
$(BUILD_DIR)/SwanInterpolateAc.o:     FFLAGS += -free-form
$(BUILD_DIR)/SwanInterpolateOutput.o: FFLAGS += -free-form
$(BUILD_DIR)/SwanInterpolatePoint.o:  FFLAGS += -free-form
$(BUILD_DIR)/SwanIntgratSpc.o:        FFLAGS += -free-form
$(BUILD_DIR)/SwanPointinMesh.o:       FFLAGS += -free-form
$(BUILD_DIR)/SwanPrepComp.o:          FFLAGS += -free-form
$(BUILD_DIR)/SwanPrintGridInfo.o:     FFLAGS += -free-form
$(BUILD_DIR)/SwanPropvelS.o:          FFLAGS += -free-form
$(BUILD_DIR)/SwanPropvelX.o:          FFLAGS += -free-form
$(BUILD_DIR)/SwanReadADCGrid.o:       FFLAGS += -free-form
$(BUILD_DIR)/SwanReadEasymeshGrid.o:  FFLAGS += -free-form
$(BUILD_DIR)/SwanReadGrid.o:          FFLAGS += -free-form
$(BUILD_DIR)/SwanReadTriangleGrid.o:  FFLAGS += -free-form
$(BUILD_DIR)/SwanSweepSel.o:          FFLAGS += -free-form
$(BUILD_DIR)/SwanThreadBounds.o:      FFLAGS += -free-form
$(BUILD_DIR)/SwanTranspAc.o:          FFLAGS += -free-form
$(BUILD_DIR)/SwanTranspX.o:           FFLAGS += -free-form
$(BUILD_DIR)/SwanVertlist.o:  FFLAGS += -freeform
$(BUILD_DIR)/waves_control.o: FFLAGS += -freeform
$(BUILD_DIR)/waves_coupler.o: FFLAGS += -freeform
