...
\\[2ex]
The locations are determined by SWAN as the intersections of the depth contour line(s) and the set of
...
{\tt [dep]}     \> the depth (in m) of the depth contour line along which output locations are\+\\
                   generated by SWAN. If the keyword {\tt DEPTH} appears in front of the value the\\
                   true depth is used, if the keyword {\tt BOTTOM} appears the water level is ignored,\\
