...
# @ job_name		= test4_0_NETCDFSST_wrfexe.$(jobid)
# @ output		= test4_0_NETCDFSST_wrfexe.$(jobid).out
# @ error		= test4_0_NETCDFSST_wrfexe.$(jobid).err
...
# on bluesky.  jan00 case modified to read SSTs via netCDF file is used.  
# All settings are hard-coded.  
# To use it, type "llsubmit test4_0_NETCDFSST_wrfexe.csh" from the 
...
cp -f namelist.input.jan00.NETCDFSST namelist.input
