...
octdimID = netcdf.defDim(nc,'ocean_time',1);
zttdimID = netcdf.defDim(nc,'zeta_time',1);
v2tdimID = netcdf.defDim(nc,'v2d_time',1);
v3tdimID = netcdf.defDim(nc,'v3d_time',1);
sltdimID = netcdf.defDim(nc,'salt_time',1);
tptdimID = netcdf.defDim(nc,'temp_time',1);
