...
!  diffusion tangent-linear and adjoint operators.                     !
!                                                                      !
!  Within the monoscale approach, B denotes a single, well-defined     !
!  spatial scale that applies to both broad and fine-scale features    !
!  in the data assimilation cost function. Error correlations are      !
!  assumed to be separable in the horizontal and vertical directions.  !
!  The horizontal pseudo-diffusion operators are implemented           !
!  explicitly, whereas the vertical operator is applied implicitly.    !
!                                                                      !
!  On Input:                                                           !
!                                                                      !
