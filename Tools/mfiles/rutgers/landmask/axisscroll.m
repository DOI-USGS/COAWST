...
% h=AXISSCROLL(type)
%  
% Places a scrollbar according with the value of
%
%     type: 'l' left axis
%           'r' right axis
%           't' top axis
%           'b' bottom
%
% If the axis limits are changed, like zooming in, a call to AXISSCROLL
% without arguments will allow to move the window. When zooming out to
% original limits the scrollbar(s) are hidden.
%
...
% svn $Id: axisscroll.m 1156 2023-02-18 01:44:37Z arango $
%=========================================================================%
