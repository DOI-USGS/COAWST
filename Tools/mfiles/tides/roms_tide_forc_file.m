...
ntidedimID = netcdf.defDim(nc_init,'ntide',ntide);

periodsID = netcdf.defVar(nc_init,'tide_period','float',[ntidedimID]);
...
ephaseID = netcdf.defVar(nc_init,'tide_Ephase','float',[xrhodimID erhodimID ntidedimID]);
...
eampID = netcdf.defVar(nc_init,'tide_Eamp','float',[xrhodimID erhodimID ntidedimID]);
...
cphaseID = netcdf.defVar(nc_init,'tide_Cphase','float',[xrhodimID erhodimID ntidedimID]);
...
cangleID = netcdf.defVar(nc_init,'tide_Cangle','float',[xrhodimID erhodimID ntidedimID]);
...
cminID = netcdf.defVar(nc_init,'tide_Cmin','float',[xrhodimID erhodimID ntidedimID]);
...
cmaxID = netcdf.defVar(nc_init,'tide_Cmax','float',[xrhodimID erhodimID ntidedimID]);
