function SWANInput(timestart,timeend,gridname,r,specpts,windstart,windend,modelgrid)
...
ofile=['INPUT'];
fid=fopen(ofile,'w');
fprintf(fid,'PROJECT ''Ctest run1'' ''''\n');
fprintf(fid,'''''\n');
fprintf(fid,'''''\n');
fprintf(fid,'''''\n');
...
fprintf(fid,'INITIAL HOTSTART ''../forcings/ctest.hot'' \n');
fprintf(fid,'\n');
fprintf(fid,'& PHYSICS  ****************************************\n');
...
fprintf(fid,'\n');
fprintf(fid,'COMPUTE NONSTAT ');
fprintf(fid,'%8.6f ',timestart);
fprintf(fid,'300 SEC ');
fprintf(fid,'%8.6f\n',timeend);
fprintf(fid,'\n');
fprintf(fid,'HOTFILE ''../forcings/ctestend.hot''\n');
fprintf(fid,'\n');
fprintf(fid,'STOP\n');
fprintf(fid,'\n');
fclose(fid);
