...
!-----------------------------------------------------------------------
      character(char_len), dimension(15) :: roms_grids
      character(char_len), dimension(15) :: swan_coord, swan_bath
      character(char_len), dimension(15) :: ww3_xcoord, ww3_ycoord
      character(char_len), dimension(15) :: ww3_bath
      character(char_len), dimension(15) :: wrf_grids, hydro_grids
      ...
      integer(int_kind),dimension(15) :: roms_parent
      integer(int_kind),dimension(15) :: swan_numx, swan_numy
      integer(int_kind),dimension(15) :: ww3_numx, ww3_numy, ww3_parent
      integer(int_kind),dimension(15) :: swan_cartesian, swan_parent
      integer(int_kind),dimension(15) :: wrf_parent_grid_ratio
      integer(int_kind),dimension(15) :: wrf_parent_id
