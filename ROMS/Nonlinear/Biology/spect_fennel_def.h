/*
** svn $Id: fennel_def.h 429 2009-12-20 17:30:26Z arango $
*************************************************** Hernan G. Arango ***
...
!
     ...
     &               SetParAccess = .FALSE.)
      ...
      Vinfo( 1)='SIGATRB'
      Vinfo( 2)='NAP absorb. cross section at 440 nm'
      Vinfo( 3)='meter2 gram-1'
      status=def_var(ng, model, ncid, varid, NF_TYPE,                   &
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
      IF (exit_flag.ne.NoError) RETURN
      ...
      Vinfo( 1)='STRB'
      Vinfo( 2)='Spectral slope of NAP absorption'
      status=def_var(ng, model, ncid, varid, NF_TYPE,                   &
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
      IF (exit_flag.ne.NoError) RETURN
      ...
      Vinfo( 1)='BLTRB'
      Vinfo( 2)='Baseline NAP absorption'
      Vinfo( 3)='meter2 gram-1'
      status=def_var(ng, model, ncid, varid, NF_TYPE,                   &
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
      ...
      Vinfo( 1)='SIGBTRB'
      Vinfo( 2)='Scattering cross section of turbidity'
      Vinfo( 3)='meter2 gram-1'
      status=def_var(ng, model, ncid, varid, NF_TYPE,                   &
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
      ...
      Vinfo( 1)='ETASPEC'
      Vinfo( 2)='Scattering spectral exponent'
      status=def_var(ng, model, ncid, varid, NF_TYPE,                   &
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
      IF (exit_flag.ne.NoError) RETURN
      ...
      Vinfo( 1)='BB2B'
      Vinfo( 2)='Particulate backscattering ratio'
      status=def_var(ng, model, ncid, varid, NF_TYPE,                   &
     &               1, (/0/), Aval, Vinfo, ncname,                     &
     &               SetParAccess = .FALSE.)
      IF (exit_flag.ne.NoError) RETURN
