...
$(BUILD_DIR)/ocpcre.o:   FFLAGS += -f fixed
$(BUILD_DIR)/ocpids.o:   FFLAGS += -f fixed
$(BUILD_DIR)/ocpmix.o:   FFLAGS += -f fixed
$(BUILD_DIR)/swancom1.o: FFLAGS += -f fixed
$(BUILD_DIR)/swancom2.o: FFLAGS += -f fixed
$(BUILD_DIR)/swancom3.o: FFLAGS += -f fixed
$(BUILD_DIR)/swancom4.o: FFLAGS += -f fixed
$(BUILD_DIR)/swancom5.o: FFLAGS += -f fixed
$(BUILD_DIR)/swanmain.o: FFLAGS += -f fixed
$(BUILD_DIR)/swanout1.o: FFLAGS += -f fixed
$(BUILD_DIR)/swanout2.o: FFLAGS += -f fixed
$(BUILD_DIR)/swanparll.o:FFLAGS += -f fixed
$(BUILD_DIR)/swanpre1.o: FFLAGS += -f fixed
$(BUILD_DIR)/swanpre2.o: FFLAGS += -f fixed
$(BUILD_DIR)/swanser.o:  FFLAGS += -f fixed
$(BUILD_DIR)/swmod1.o:   FFLAGS += -f fixed
$(BUILD_DIR)/swmod2.o:       FFLAGS += -f fixed
$(BUILD_DIR)/SwanSpectPart.o:FFLAGS += -f fixed
$(BUILD_DIR)/m_constants.o:  FFLAGS += -f free
$(BUILD_DIR)/m_fileio.o:     FFLAGS += -f free
$(BUILD_DIR)/mod_xnl4v5.o:   FFLAGS += -f free
$(BUILD_DIR)/serv_xnl4v5.o:  FFLAGS += -f free
$(BUILD_DIR)/nctablemd.o:    FFLAGS += -f free
$(BUILD_DIR)/agioncmd.o:     FFLAGS += -f free
$(BUILD_DIR)/swn_outnc.o:    FFLAGS += -f free
$(BUILD_DIR)/SdsBabanin.o:   FFLAGS += -f free
$(BUILD_DIR)/SwanBpntlist.o: FFLAGS += -f free
$(BUILD_DIR)/SwanCheckGrid.o:FFLAGS += -f free
$(BUILD_DIR)/SwanCompdata.o: FFLAGS += -f free
$(BUILD_DIR)/SwanCompUnstruc.o:       FFLAGS += -f free
$(BUILD_DIR)/SwanComputeForce.o:      FFLAGS += -f free
$(BUILD_DIR)/SwanConvAccur.o:         FFLAGS += -f free
$(BUILD_DIR)/SwanConvStopc.o:         FFLAGS += -f free
$(BUILD_DIR)/SwanCreateEdges.o:       FFLAGS += -f free
$(BUILD_DIR)/SwanCrossObstacle.o:     FFLAGS += -f free
$(BUILD_DIR)/SwanDiffPar.o:           FFLAGS += -f free
$(BUILD_DIR)/SwanDispParm.o:          FFLAGS += -f free
$(BUILD_DIR)/SwanFindObstacles.o:     FFLAGS += -f free
$(BUILD_DIR)/SwanFindPoint.o:         FFLAGS += -f free
$(BUILD_DIR)/SwanGridCell.o:          FFLAGS += -f free
$(BUILD_DIR)/SwanGriddata.o:          FFLAGS += -f free
$(BUILD_DIR)/SwanGridFace.o:          FFLAGS += -f free
$(BUILD_DIR)/SwanGridobjects.o:       FFLAGS += -f free
$(BUILD_DIR)/SwanGridTopology.o:      FFLAGS += -f free
$(BUILD_DIR)/SwanGridVert.o:          FFLAGS += -f free
$(BUILD_DIR)/SwanGSECorr.o:           FFLAGS += -f free
$(BUILD_DIR)/SwanInitCompGrid.o:      FFLAGS += -f free
$(BUILD_DIR)/SwanInterpolateAc.o:     FFLAGS += -f free
$(BUILD_DIR)/SwanInterpolateOutput.o: FFLAGS += -f free
$(BUILD_DIR)/SwanInterpolatePoint.o:  FFLAGS += -f free
$(BUILD_DIR)/SwanIntgratSpc.o:        FFLAGS += -f free
$(BUILD_DIR)/SwanPointinMesh.o:       FFLAGS += -f free
$(BUILD_DIR)/SwanPrepComp.o:          FFLAGS += -f free
$(BUILD_DIR)/SwanPrintGridInfo.o:     FFLAGS += -f free
$(BUILD_DIR)/SwanPropvelS.o:          FFLAGS += -f free
$(BUILD_DIR)/SwanPropvelX.o:          FFLAGS += -f free
$(BUILD_DIR)/SwanReadADCGrid.o:       FFLAGS += -f free
$(BUILD_DIR)/SwanReadEasymeshGrid.o:  FFLAGS += -f free
$(BUILD_DIR)/SwanReadGrid.o:          FFLAGS += -f free
$(BUILD_DIR)/SwanReadTriangleGrid.o:  FFLAGS += -f free
$(BUILD_DIR)/SwanSweepSel.o:          FFLAGS += -f free
$(BUILD_DIR)/SwanThreadBounds.o:      FFLAGS += -f free
$(BUILD_DIR)/SwanTranspAc.o:          FFLAGS += -f free
$(BUILD_DIR)/SwanTranspX.o:           FFLAGS += -f free
$(BUILD_DIR)/SwanVertlist.o:  FFLAGS += -f free
$(BUILD_DIR)/waves_control.o: FFLAGS += -f free
$(BUILD_DIR)/waves_coupler.o: FFLAGS += -f free
