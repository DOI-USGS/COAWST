#!/bin/csh -f
#
# svn $Id: job_w4dvar.sh 503 2008-01-10 00:11:51Z arango $
#######################################################################
...
#######################################################################
#                                                                     #
# Weak constraint, 4DVAR job script:                                  #
#                                                                     #
...
#   (3) It copies representer model initial condition, same as        #
#       nonlinear model.                                              #
#   (4) Set model error covariance standard deviation and             #
#       normalization coefficients NetCDF files.                      #
#   (5) Copy a clean copy of the observations NetCDF file.            #
#   (6) Create 4DVAR input script from a template and specify the     #
...
# model.
 ...
 cp -p ${PREFIX}_ini.nc ${PREFIX}_irp.nc
