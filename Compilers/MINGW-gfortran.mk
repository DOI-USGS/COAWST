...
$(BUILD_DIR)/ocpcre.o: FFLAGS += -ffixed-form
$(BUILD_DIR)/ocpids.o: FFLAGS += -ffixed-form
$(BUILD_DIR)/ocpmix.o: FFLAGS += -ffixed-form
$(BUILD_DIR)/swancom1.o: FFLAGS += -ffixed-form
$(BUILD_DIR)/swancom2.o: FFLAGS += -ffixed-form
$(BUILD_DIR)/swancom3.o: FFLAGS += -ffixed-form
$(BUILD_DIR)/swancom4.o: FFLAGS += -ffixed-form
$(BUILD_DIR)/swancom5.o: FFLAGS += -ffixed-form
$(BUILD_DIR)/swanmain.o: FFLAGS += -ffixed-form
$(BUILD_DIR)/swanout1.o: FFLAGS += -ffixed-form
$(BUILD_DIR)/swanout2.o: FFLAGS += -ffixed-form
$(BUILD_DIR)/swanparll.o: FFLAGS += -ffixed-form
$(BUILD_DIR)/swanpre1.o: FFLAGS += -ffixed-form
$(BUILD_DIR)/swanpre2.o: FFLAGS += -ffixed-form
$(BUILD_DIR)/swanser.o: FFLAGS += -ffixed-form
$(BUILD_DIR)/swmod1.o: FFLAGS += -ffixed-form
$(BUILD_DIR)/swmod2.o: FFLAGS += -ffixed-form
$(BUILD_DIR)/SwanSpectPart.o:  FFLAGS += -ffixed-form
$(BUILD_DIR)/m_constants.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/m_fileio.o:    FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/mod_xnl4v5.o:  FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/serv_xnl4v5.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/nctablemd.o:   FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/agioncmd.o:    FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/swn_outnc.o:   FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SdsBabanin.o:  FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanBpntlist.o:  FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanCheckGrid.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanCompdata.o:  FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanCompUnstruc.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanComputeForce.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanConvAccur.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanConvStopc.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanCreateEdges.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanCrossObstacle.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanDiffPar.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanDispParm.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanFindObstacles.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanFindPoint.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanGridCell.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanGriddata.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanGridFace.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanGridobjects.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanGridTopology.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanGridVert.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanGSECorr.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanInitCompGrid.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanInterpolateAc.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanInterpolateOutput.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanInterpolatePoint.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanIntgratSpc.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanPointinMesh.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanPrepComp.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanPrintGridInfo.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanPropvelS.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanPropvelX.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanReadADCGrid.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanReadEasymeshGrid.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanReadGrid.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanReadTriangleGrid.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanSweepSel.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanThreadBounds.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanTranspAc.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanTranspX.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/SwanVertlist.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/waves_control.o: FFLAGS += -ffree-form -ffree-line-length-none
$(BUILD_DIR)/waves_coupler.o: FFLAGS += -ffree-form -ffree-line-length-none
