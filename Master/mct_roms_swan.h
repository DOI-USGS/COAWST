...
** git $Id$
***************************************************** John C. Warner ***
** Copyright (c) 2002-2026 The ROMS Group           Hernan G. Arango  **
**   Licensed under a MIT/X style license                             **
**   See License_ROMS.md                                              **
************************************************************************
**                                                                    **
** These routines couple ROMS to the SWAN wave model using            **
...
!
            cff1=OCEAN(ng)%uwave(i,j,k)*GRID(ng)%CosAngler(i,j)-        &
     &           OCEAN(ng)%vwave(i,j,k)*GRID(ng)%SinAngler(i,j)
# else
            cff1=OCEAN(ng)%uwave(i,j,k)
# endif
            A(ij)=cff1
          END DO
        END DO
...
!
            cff1=OCEAN(ng)%uwave(i,j,k)*GRID(ng)%SinAngler(i,j)+        &
     &           OCEAN(ng)%vwave(i,j,k)*GRID(ng)%CosAngler(i,j)
# else
            cff1=OCEAN(ng)%vwave(i,j,k)
# endif
            A(ij)=cff1
          END DO
        END DO
...
!
      ...
      DO j=JstrR,JendR
        DO i=IstrR,IendR
          ...
          cff=0.0
          DO iveg=1,NVEG
            cff=VEG(ng)%plant(i,j,iveg,isDens)+cff
          END DO
          A(ij)=cff/NVEG
        END DO
      END DO
...
!
      ...
      DO j=JstrR,JendR
        DO i=IstrR,IendR
          ...
          cff=0.0
          DO iveg=1,NVEG
            cff=VEG(ng)%plant(i,j,iveg,isHght)+cff
          END DO
          A(ij)=cff/NVEG
        END DO
      END DO
...
!
      ...
      DO j=JstrR,JendR
        DO i=IstrR,IendR
          ...
          cff=0.0
          DO iveg=1,NVEG
            cff=VEG(ng)%plant(i,j,iveg,isDiam)+cff
          END DO
          A(ij)=cff/NVEG
        END DO
      END DO
...
!
      ...
      DO j=JstrR,JendR
        DO i=IstrR,IendR
          ...
          cff=0.0
          DO iveg=1,NVEG
            cff=VEG(ng)%plant(i,j,iveg,isThck)+cff
          END DO
          A(ij)=cff/NVEG
        END DO
      END DO
