...
%
% jcwarner14July2014 - orig
%         17Sept2014 - limit calls to non used grids
%
...
%
if ((Ngrids_swan>0) & (Ngrids_roms>0))
  for mw=1:Ngrids_swan
    tot_mask{mw}=0;
    for mo=1:Ngrids_roms
