...
%   If it already exists it will be overwritten!!.
     init_file='duck_xshore_roms_ini.nc';
...
%5) Obtain grid information.
   grid_file='duck_xshore_grd.nc'    %<-enter name of grid here
...
%  These values should coincide with your sediment.in file.
  ...
  sand_Sd50=[0.61]/1000;             %m,      NNS values
  sand_Wsed=[100]/1000;              %m s-1,  NNS values
  sand_tau_ce=[0.4019];               %N m-2,  NNS values
