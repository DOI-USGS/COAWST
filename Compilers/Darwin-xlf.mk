...
$(BUILD_DIR)/ocpcre.o:   FFLAGS += -qfixed
$(BUILD_DIR)/ocpids.o:   FFLAGS += -qfixed
$(BUILD_DIR)/ocpmix.o:   FFLAGS += -qfixed
$(BUILD_DIR)/swancom1.o: FFLAGS += -qfixed
$(BUILD_DIR)/swancom2.o: FFLAGS += -qfixed
$(BUILD_DIR)/swancom3.o: FFLAGS += -qfixed
$(BUILD_DIR)/swancom4.o: FFLAGS += -qfixed
$(BUILD_DIR)/swancom5.o: FFLAGS += -qfixed
$(BUILD_DIR)/swanmain.o: FFLAGS += -qfixed
$(BUILD_DIR)/swanout1.o: FFLAGS += -qfixed
$(BUILD_DIR)/swanout2.o: FFLAGS += -qfixed
$(BUILD_DIR)/swanparll.o:FFLAGS += -qfixed
$(BUILD_DIR)/swanpre1.o: FFLAGS += -qfixed
$(BUILD_DIR)/swanpre2.o: FFLAGS += -qfixed
$(BUILD_DIR)/swanser.o:  FFLAGS += -qfixed
$(BUILD_DIR)/swmod1.o:   FFLAGS += -qfixed
$(BUILD_DIR)/swmod2.o:       FFLAGS += -qfixed
$(BUILD_DIR)/SwanSpectPart.o:FFLAGS += -qfixed
$(BUILD_DIR)/m_constants.o:  FFLAGS += -qfree
$(BUILD_DIR)/m_fileio.o:     FFLAGS += -qfree
$(BUILD_DIR)/mod_xnl4v5.o:   FFLAGS += -qfree
$(BUILD_DIR)/serv_xnl4v5.o:  FFLAGS += -qfree
$(BUILD_DIR)/nctablemd.o:    FFLAGS += -qfree
$(BUILD_DIR)/agioncmd.o:     FFLAGS += -qfree
$(BUILD_DIR)/swn_outnc.o:    FFLAGS += -qfree
$(BUILD_DIR)/SdsBabanin.o:   FFLAGS += -qfree
$(BUILD_DIR)/SwanBpntlist.o: FFLAGS += -qfree
$(BUILD_DIR)/SwanCheckGrid.o:FFLAGS += -qfree
$(BUILD_DIR)/SwanCompdata.o: FFLAGS += -qfree
$(BUILD_DIR)/SwanCompUnstruc.o:       FFLAGS += -qfree
$(BUILD_DIR)/SwanComputeForce.o:      FFLAGS += -qfree
$(BUILD_DIR)/SwanConvAccur.o:         FFLAGS += -qfree
$(BUILD_DIR)/SwanConvStopc.o:         FFLAGS += -qfree
$(BUILD_DIR)/SwanCreateEdges.o:       FFLAGS += -qfree
$(BUILD_DIR)/SwanCrossObstacle.o:     FFLAGS += -qfree
$(BUILD_DIR)/SwanDiffPar.o:           FFLAGS += -qfree
$(BUILD_DIR)/SwanDispParm.o:          FFLAGS += -qfree
$(BUILD_DIR)/SwanFindObstacles.o:     FFLAGS += -qfree
$(BUILD_DIR)/SwanFindPoint.o:         FFLAGS += -qfree
$(BUILD_DIR)/SwanGridCell.o:          FFLAGS += -qfree
$(BUILD_DIR)/SwanGriddata.o:          FFLAGS += -qfree
$(BUILD_DIR)/SwanGridFace.o:          FFLAGS += -qfree
$(BUILD_DIR)/SwanGridobjects.o:       FFLAGS += -qfree
$(BUILD_DIR)/SwanGridTopology.o:      FFLAGS += -qfree
$(BUILD_DIR)/SwanGridVert.o:          FFLAGS += -qfree
$(BUILD_DIR)/SwanGSECorr.o:           FFLAGS += -qfree
$(BUILD_DIR)/SwanInitCompGrid.o:      FFLAGS += -qfree
$(BUILD_DIR)/SwanInterpolateAc.o:     FFLAGS += -qfree
$(BUILD_DIR)/SwanInterpolateOutput.o: FFLAGS += -qfree
$(BUILD_DIR)/SwanInterpolatePoint.o:  FFLAGS += -qfree
$(BUILD_DIR)/SwanIntgratSpc.o:        FFLAGS += -qfree
$(BUILD_DIR)/SwanPointinMesh.o:       FFLAGS += -qfree
$(BUILD_DIR)/SwanPrepComp.o:          FFLAGS += -qfree
$(BUILD_DIR)/SwanPrintGridInfo.o:     FFLAGS += -qfree
$(BUILD_DIR)/SwanPropvelS.o:          FFLAGS += -qfree
$(BUILD_DIR)/SwanPropvelX.o:          FFLAGS += -qfree
$(BUILD_DIR)/SwanReadADCGrid.o:       FFLAGS += -qfree
$(BUILD_DIR)/SwanReadEasymeshGrid.o:  FFLAGS += -qfree
$(BUILD_DIR)/SwanReadGrid.o:          FFLAGS += -qfree
$(BUILD_DIR)/SwanReadTriangleGrid.o:  FFLAGS += -qfree
$(BUILD_DIR)/SwanSweepSel.o:          FFLAGS += -qfree
$(BUILD_DIR)/SwanThreadBounds.o:      FFLAGS += -qfree
$(BUILD_DIR)/SwanTranspAc.o:          FFLAGS += -qfree
$(BUILD_DIR)/SwanTranspX.o:           FFLAGS += -qfree
$(BUILD_DIR)/SwanVertlist.o:  FFLAGS += -qfree
$(BUILD_DIR)/waves_control.o: FFLAGS += -qfree
$(BUILD_DIR)/waves_coupler.o: FFLAGS += -qfree
