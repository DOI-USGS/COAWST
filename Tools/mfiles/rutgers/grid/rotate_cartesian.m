function R = rotate_cartesian (D, Im, Jm, dx, dy, Xc, Yc, theta, plt)

%
% ROTATE_CARTESIAN: Computes a rotated Cartesian grid
%
% R = rotate_cartesian (D, Im, Jm, dx, dy, Xc, Yc, theta, plt)
%
...
%                (degrees)
%
%    plt        Switch to plot computed rotated grid (OPTIONAL, logical,
%                 default = false)
%
% On Output:
%
...
CosAngle = cos(theta*deg2rad);
SinAngle = sin(theta*deg2rad);
